# An implementation of Partitioning Around Medoids (PAM), taken from https://github.com/SachinKalsi/kmedoids
from scipy.sparse import csr_matrix
import numpy as np
import random

def hamming_distance (X1, X2):
    assert(len(X1)==len(X2) and X1.dtype==X2.dtype and X1.dtype==np.uint8)
